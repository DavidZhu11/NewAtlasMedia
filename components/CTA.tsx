  ...
  return (
    <section className="py-20 sm:py-32 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-white mb-6 sm:mb-8 tracking-tight">
        ...
        <div className="bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-14 inline-flex flex-col items-center w-full max-w-2xl shadow-2xl">
          <div className="inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-brand-purple/20 text-brand-purple mb-4 sm:mb-6">
            <Clock size={20} className="sm:hidden" />
            <Clock size={24} className="hidden sm:block" />
          </div>

          <h3 className="text-2xl sm:text-3xl font-bold text-white mb-3">What You'll Discover:</h3>

          {/* Value Bullets */}
          <ul className="text-left space-y-3 mb-6 sm:mb-8 w-full max-w-md">
            <li className="flex items-start gap-2 sm:gap-3 text-sm sm:text-base text-slate-300">
              <CheckCircle size={18} className="text-green-500 mt-0.5 flex-shrink-0 sm:hidden" />
              <CheckCircle size={20} className="text-green-500 mt-0.5 flex-shrink-0 hidden sm:block" />
