    ...
    return (
        <section id="about" className="py-20 sm:py-32 bg-brand-panel border-y border-white/5 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                {/* Section Header */}
                <div className="text-center max-w-4xl mx-auto mb-12 sm:mb-20 px-2">
                ...
                <div className="max-w-4xl mx-auto mb-12 sm:mb-20">
                    <div className="bg-gradient-to-br from-brand-purple/10 to-transparent border border-brand-purple/30 rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-14 text-center">
                ...
                <div className="grid gap-4 sm:gap-6 grid-cols-2 lg:grid-cols-4">
                    {values.map((value, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="group bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl p-5 sm:p-8 hover:bg-white/[0.07] hover:border-brand-purple/30 transition-all duration-300 text-center"
                            >
                                <div className="inline-flex items-center justify-center w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-brand-purple/20 text-brand-purple mb-4 sm:mb-6 group-hover:scale-110 transition-transform">
                                    <Icon size={20} className="sm:hidden" />
                                    <Icon size={28} className="hidden sm:block" />
                                </div>
                                <h3 className="text-sm sm:text-lg font-bold text-white mb-2 sm:mb-3">{value.title}</h3>
