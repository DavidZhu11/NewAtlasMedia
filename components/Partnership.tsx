      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Incentives Aligned with <br/>
              <span className="text-brand-purple">Your Bottom Line.</span>
            </h2>
            <p className="text-lg text-slate-400">
              We don’t believe in "management fees." We believe in upside. Our model is designed to ensure our team is as invested in your P&L as you are.
            </p>
        </div>
