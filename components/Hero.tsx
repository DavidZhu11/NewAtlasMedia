        ...
        <section className="relative overflow-hidden bg-black min-h-screen flex items-center justify-center pt-20 pb-32">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full z-10 flex flex-col items-center">
                ...
                <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black tracking-tighter text-white mb-8 hero-text-glow leading-[0.9] text-center">
                    We Scale Founder-Led<br />
                    <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-purple-300">Businesses to $1M+.</span>
                </h1>

                {/* Sub-headline - Concrete Outcomes */}
                <p className="text-lg sm:text-xl md:text-2xl text-slate-400 max-w-3xl mb-14 leading-relaxed font-light text-center">
                    If you're generating <span className="text-white font-medium">$100k-$500k/year</span> and ready to break through, we install the exact growth systems used by our private equity partners. <span className="text-white font-medium">Average client ROI: 3.2x in 12 months.</span>
                </p>
